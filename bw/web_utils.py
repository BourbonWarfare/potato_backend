...
def define_async_api(func: Callable[..., Awaitable[WebResponse]]):
    ...
    *Docstring generated by AI.*
    ...
    Wraps async API functions to automatically catch and handle BwServerError exceptions,
    ...
    **Returns:**
    - `Callable[..., Awaitable[WebResponse]]`: A wrapped function that handles BwServerError exceptions automatically.
...
def define_api(func: Callable[..., WebResponse]):
    ...
    **Returns:**
    - `Callable[..., WebResponse]`: A wrapped function that handles BwServerError exceptions automatically.
