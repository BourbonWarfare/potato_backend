...
def test__create_permission__can_create_no_throw(state, permission_1):
...
def test__create_permission__can_only_create_single_name(state, permission_1):
    GroupStore().create_permission(state, 'my permission', permission_1)
    with pytest.raises(GroupPermissionCreationFailed):
        GroupStore().create_permission(state, 'my permission', permission_1)


def test__create_group__can_create_no_throw(state, db_permission_1):
...
def test__create_group__can_only_create_single(state, db_permission_1):
...
def test__get_permission__can_get_valid_permission(state, db_permission_1):
...
def test__get_permission__cant_get_invalid_permission(state, db_permission_1, permission_name_2):
    with pytest.raises(NoGroupPermissionWithCredentials):
        GroupStore().get_permission(state, permission_name_2)


def test__edit_permission__can_edit_permission(state, db_permission_1, permission_2):
...
def test__edit_permission__cant_edit_nonexistant_permission(state, db_permission_1, permission_2, permission_name_2):
    with pytest.raises(NoGroupPermissionWithCredentials):
        GroupStore().edit_permission(state, permission_name_2, permission_2)


def test__assign_user_to_group__can_assign(state, db_group_1, db_user_1):
...
def test__assign_user_to_group__can_assign_only_once(state, db_group_1, db_user_1):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    with pytest.raises(GroupAssignmentFailed):
        GroupStore().assign_user_to_group(state, db_user_1, db_group_1)


def test__assign_user_to_group__can_assign_many_users_to_group(state, db_group_1, db_user_1, db_user_2):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
...
def test__assign_user_to_group__can_assign_user_to_many_groups(state, db_group_1, db_user_1, db_group_2):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
...
def test__remove_user_from_group__can_remove_user(state, db_group_1, db_user_1):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    with state.Session.begin() as session:
        query = select(UserGroup).where(UserGroup.user_id == db_user_1.id).where(UserGroup.group_id == db_group_1.id)
        row = session.execute(query).first()
...
def test__remove_user_from_group__nothing_if_cant_remove_user(state, db_group_1, db_user_1):
    GroupStore().remove_user_from_group(state, db_user_1, db_group_1)


def test__remove_user_from_group__no_error_if_user_not_in_group(state, db_group_1, db_user_2):
...
def test__delete_group__can_delete_empty(state, db_group_1):
    GroupStore().delete_group(state, db_group_1.name)


def test__delete_group__can_delete_with_user(state, db_group_1, db_user_1):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    GroupStore().delete_group(state, db_group_1.name)


def test__delete_group__can_delete_with_users(state, db_group_1, db_user_1, db_user_2):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    GroupStore().assign_user_to_group(state, db_user_2, db_group_1)
    GroupStore().delete_group(state, db_group_1.name)


def test__delete_group__can_delete_with_user_only_one_group(state, db_group_1, db_user_1, db_group_2):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    GroupStore().assign_user_to_group(state, db_user_1, db_group_2)
    GroupStore().delete_group(state, db_group_1.name)
...
def test__delete_group__no_error_if_group_does_not_exist(state, group_name_1):
    GroupStore().delete_group(state, group_name_1)


def test__get_all_permissions_user_has__no_permissions_if_not_in_group(state, db_user_1):
...
def test__get_all_permissions_user_has__user_has_expected_permissions_from_single_group(
    state, db_user_1, db_group_1, db_permission_1
):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    permissions = GroupStore().get_all_permissions_user_has(state, db_user_1)
...
def test__get_all_permissions_user_has__user_has_expected_permissions_from_single_group_with_many(
    state, db_user_1, db_group_1, db_permission_1, db_group_2
):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    permissions = GroupStore().get_all_permissions_user_has(state, db_user_1)
    assert db_permission_1.into_permissions().as_dict() == permissions.as_dict()
...
def test__get_all_permissions_user_has__user_has_expected_permissions_from_many_groups(
    state, db_user_1, db_group_1, db_permission_1, db_group_2, db_permission_2
):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    GroupStore().assign_user_to_group(state, db_user_1, db_group_2)
    permissions = GroupStore().get_all_permissions_user_has(state, db_user_1)
...
def test__get_group__can_get_existing_group(state, db_group_1):
    group = GroupStore().get_group(state, db_group_1.name)
    assert group.id == db_group_1.id
    assert group.name == db_group_1.name


def test__get_group__raises_on_nonexistent_group(state, group_name_1):
    with pytest.raises(NoGroupWithName):
        GroupStore().get_group(state, group_name_1)


def test__get_user_groups__returns_all_groups(state, db_user_1, db_group_1, db_group_2, db_group_3):
    GroupStore().assign_user_to_group(state, db_user_1, db_group_1)
    GroupStore().assign_user_to_group(state, db_user_1, db_group_2)
...
def test__get_all_permissions__single_permission_returns_correctly(state, db_permission_1):
...
def test__get_all_permissions__returns_correct_permission_details(state, db_permission_1, permission_1, permission_name_1):
...
def test__get_all_permissions__permissions_are_detached_from_session(state, db_permission_1):
...
def test__get_all_groups__single_group_returns_correctly(state, db_group_1):
...
def test__get_all_groups__returns_correct_group_details(state, db_group_1, group_name_1, db_permission_1):
...
def test__get_all_groups__groups_are_detached_from_session(state, db_group_1):
...
def test__get_all_groups__groups_with_users_still_returned(state, db_group_1, db_user_1):
...
def test__delete_permission__can_delete_existing_permission(state, db_permission_1):
...
def test__delete_permission__raises_on_nonexistent_permission(state, permission_name_1):
    """Test that deleting non-existent permission raises error"""
    with pytest.raises(NoGroupPermissionWithCredentials):
        GroupStore().delete_permission(state, permission_name_1)


def test__delete_permission__can_delete_multiple_permissions(state, db_permission_1, db_permission_2, db_permission_3):
...
def test__delete_permission__delete_does_not_affect_other_permissions(state, db_permission_1, db_permission_2):
...
def test__delete_permission__empty_database_after_all_deleted(state, db_permission_1, db_permission_2, db_permission_3):
...
def test__delete_permission__cannot_delete_same_permission_twice(state, db_permission_1):
