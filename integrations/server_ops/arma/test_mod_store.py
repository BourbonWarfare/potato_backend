...
def test__create_mod__success(state, workshop_details_1):
...
def test__create_mod__duplicate_raises(state, workshop_details_1, db_mod_1):
    with pytest.raises(ModAlreadyExists):
        ModStore().create_mod(state, workshop_details_1)


def test__get_mod_by_workshop_id__success(state, db_mod_1):
...
def test__get_mod_by_workshop_id__not_found_raises(state):
    with pytest.raises(ModNotFound):
        ModStore().get_mod_by_workshop_id(state, WorkshopId(0))


def test__update_mod__success(state, db_mod_1, updated_workshop_details_1):
...
def test__update_mod__not_found_raises(state, workshop_details_1):
    with pytest.raises(ModNotFound):
        ModStore().update_mod(state, workshop_details_1)


def test__get_out_of_date_mods__success(state, db_mod_1, db_mod_2, workshop_details_2, updated_workshop_details_1):
...
def test__get_out_of_date_mods__null_date_is_success(state, db_mod_4, updated_workshop_details_4):
...
def test__get_out_of_date_mods__no_out_of_date_mods(state, db_mod_1, db_mod_2, workshop_details_2, workshop_details_1):
    result = ModStore().get_out_of_date_mods(state, [workshop_details_1, workshop_details_2])

    assert len(result) == 0


def test__get_out_of_date_mods__only_returns_mods_given(state, db_mod_1, db_mod_2, updated_workshop_details_1):
...
def test__get_all_mods__success(state, db_mod_1, db_mod_2):
...
def test__get_all_mods__no_mods_empty(state):
    result = ModStore().get_all_mods(state)

    assert len(result) == 0


def test__delete_mod__success_with_steam_workshop_details(state, db_mod_1, db_mod_2, workshop_details_1):
...
def test__delete_mod__success_with_mod_object(state, db_mod_1, db_mod_2, mod_1):
...
def test__delete_mod__success_with_workshop_id(state, db_mod_1, db_mod_2, workshop_details_1):
...
def test__delete_mod__no_mod_nothing(state, db_mod_1, db_mod_2, null_mod):
    with pytest.raises(ModFieldInvalid):
        ModStore().delete_mod(state, null_mod)


def test__bulk_update__success(state, db_mod_1, db_mod_2, db_mod_3, updated_workshop_details_1, updated_workshop_details_2):
...
def test__bulk_update__no_mod_fails(state, db_mod_1, db_mod_3, updated_workshop_details_1, updated_workshop_details_2):
    with pytest.raises(ModNotFound):
        ModStore().bulk_update_mods(state, [updated_workshop_details_1, updated_workshop_details_2])


def test__bulk_update__no_updates_success(state, db_mod_1, db_mod_2, db_mod_3):
