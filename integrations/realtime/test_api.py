...
def test__push_event__creates_event_and_queued_event_in_database(state, mock_event_1):
...
def test__publish_queued_events__publishes_and_removes_queued_events(state, db_queued_event_1, db_queued_event_2):
...
def test__publish_queued_events__with_empty_list_changes_nothing(state, db_queued_event_1, db_queued_event_2):
