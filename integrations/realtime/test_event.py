...
def test__create_event__persists_event_to_database(state, mock_event_1):
...
def test__create_event__persists_event_to_database_no_id(state, mock_event_no_id):
    """Test that create_event writes an Event row with the correct fields."""
...
def test__create_event__returns_detached_event_model(state, mock_event_1):
...
def test__queue_event__persists_queued_event_to_database(state, db_event_1):
...
def test__queue_event__returns_detached_queued_event_model(state, db_event_1):
...
def test__publish_queued_event_bulk__creates_published_event_rows(state, db_queued_event_1, db_queued_event_2):
...
def test__publish_queued_event_bulk__returns_published_event_models(state, db_queued_event_1):
...
def test__pop_queued_event_bulk__removes_queued_event_rows(state, db_queued_event_1, db_queued_event_2):
...
def test__pop_queued_event_bulk__leaves_unrelated_queued_events_intact(state, db_queued_event_1, db_queued_event_2):
...
def test__web_event_from_model__reconstructs_correct_event_type(state, db_event_1, mock_event_message_1):
...
def test__web_event_from_model__raises_when_event_not_registered(state, db_event_1, unregistered_event_string):
...
def test__web_events_from_database__returns_all_events_when_no_filters(state, db_event_1, db_event_2):
...
def test__web_events_from_database__filters_by_encoded_event_name(state, db_event_1, db_event_different_event, mock_event_1):
...
def test__web_events_from_database__returns_empty_tuple_when_no_matches(state, db_event_1):
...
def test__web_events_from_database__filters_by_namespace(state, db_event_1, db_event_different_namespace):
...
def test__queued_events_from_database__returns_all_when_no_filters(state, db_queued_event_1, db_queued_event_2):
...
def test__queued_events_from_database__filters_by_encoded_event_name(
    state, uuid1, uuid2, mock_event_1, db_queued_event_1, db_queued_event_2
):
...
def test__queued_events_from_database__filters_by_event_id(state, db_event_1, db_queued_event_1, db_queued_event_different_event):
...
def test__queued_events_from_database__filters_by_namespace(
    state, db_queued_event_1, db_queued_event_different_event, db_queued_event_different_namespace
):
...
def test__queued_events_from_database__namespace_filter_excludes_non_matching(state, db_queued_event_1):
...
def test__queued_events_from_database__filters_by_after_datetime(state, uuid1, db_queued_event_1, db_queued_event_2):
...
def test__queued_events_from_database__each_result_is_queued_event_and_event_pair(state, db_event_1, db_queued_event_1):
